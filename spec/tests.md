...
| TC-006 | Every id form the corpus writes is accepted — bare `TC-707`, criterion `FR-047-AC-1`, mixed-case kind `StR-004-AC-2`, constraint `FR-003-CON-1`, alphanumeric suffix `TC-001a` (`is_id_shaped` unit tests) | Unit | P0 | FR-003-AC-1 | ✅ |
