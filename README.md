...
Adopting this crate therefore needs one line in the consumer's `deny.toml`,
because the sibling repos allow AGPL for their own crate only and keep their
third-party allow-list permissive:
